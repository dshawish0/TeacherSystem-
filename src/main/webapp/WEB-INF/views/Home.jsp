...
<style>
    ...
    body {
        background: #bcdee7 url("https://external-preview.redd.it/68mmQ3ZxHRMXb-3aSaL6O1r33pACvuXXwc4FUf8smpE.jpg?auto=webp&s=8a90a7e7cb20328bc42c9e87cd212a5118fcd987") no-repeat center center fixed;
    ...
    .profile-card header a:after {
        ...
        transform: scale(0);
        background: -webkit-linear-gradient(top, #31a24c 0%, #31a24c 50%, #31a24c 50%, #31a24c 100%);
        background: linear-gradient(#31a24c 0%, #31a24c 50%, #31a24c 50%, #31a24c 100%);
        -webkit-border-radius: 50%;
        border-radius: 50%;
...
<aside class="profile-card">
    ...
    <header>
        ...
        <!-- here’s the avatar -->
        <a>
            <img src="https://www.htcestore.com/media/catalog/product/cache/ccb47da442ebb206d74aa361802c6e2c/p/r/profile.png" alt="avatarProf"/>
        </a>
    ...
    <div>
        <center>
            <a href="/Students" class="button4" style="background-color:#4e9af1">Show Your Students</a>
        </center>
